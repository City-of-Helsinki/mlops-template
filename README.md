...
The core structure of the repository is the following:
    ...
    04_workflow.ipynb   # Define ML workflow and parameterization
...
2. Remember to activate your virtual environment every time you begin work: `conda activate [environment name]` with anaconda or `source [environment name]/bin/activate` with virtualenv
